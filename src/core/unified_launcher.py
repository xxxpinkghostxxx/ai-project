...
# Local imports - Utils
from src.utils.print_utils import print_error, print_info, print_success, print_warning
...
class UnifiedLauncher:
    ...
    def test_system_capacity(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logging.error("System capacity test failed - OS/Runtime error: %s", str(e))
    ...
    def launch_with_profile(self, profile: str) -> bool:
        ...
        try:
            ...
            logging.error("Launch operation failed - Runtime/OS error: %s", str(e))
    ...
    def _launch_ui(self, config: Dict[str, Any], service_registry: IServiceRegistry) -> bool:
        ...
        try:
            ...
            logging.error("UI launch failed - Import/Runtime error: %s", str(e))
...
def main():
    ...
    try:
        ...
        logging.error("Service resolution failed - Runtime/OS error: %s", str(e))

...
#     __init__(self, workspace_system: WorkspaceNodeSystem)
#
#     start_visualization(self, dedicated_window: bool = False) -> bool
#       Start the visualization system
#
#     stop_visualization(self)
#       Stop the visualization system
#
#     _configure_visualization(self)
#       Configure the visualization window with settings
#
#     get_visualization_widget(self) -> Optional[Any]
#       Get the visualization widget for embedding in other UIs
#
#     update_configuration(self, config: dict)
#       Update visualization configuration
#
#     get_status(self) -> dict
#       Get current visualization status
#
#     export_visualization(self, filename: str) -> bool
...
#
#     set_visualization_mode(self, mode: str)
#       Set visualization mode
#
#     set_zoom_level(self, zoom: float)
#       Set zoom level
#
#     show_node_info(self, node_id: int)
...
"""Integration between workspace system and real-time visualization window."""

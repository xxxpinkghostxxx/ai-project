...
- **Setup Guide**: [docs/README_SETUP.md](docs/README_SETUP.md) - Detailed installation and setup instructions
- **Getting Started**: [docs/GETTING_STARTED.md](docs/GETTING_STARTED.md) - Beginner's guide to the project
- **API Documentation**: [docs/technical/API_DOCUMENTATION/](docs/technical/API_DOCUMENTATION/) - Comprehensive API reference
- **Contributing**: [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) - Guidelines for contributing to the project

---

_This living document serves as the central reference for the Energy-Based Neural System project. Refer to it when considering changes or additions to maintain alignment with the core vision and development principles._

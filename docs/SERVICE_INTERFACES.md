...
The AI Neural Simulation System has been fully migrated to a service-oriented architecture (SOA) with multiple specialized services orchestrated by the SimulationCoordinator. The monolithic SimulationManager has been completely removed.

For comprehensive SOA architecture information, see [SOA_ARCHITECTURE.md](../SOA_ARCHITECTURE.md). This document focuses on the service interfaces and their contracts.
...
For detailed information about service implementations, see [SOA_ARCHITECTURE.md](../SOA_ARCHITECTURE.md).
...
For information about the migration from monolithic design to SOA, see [SOA_ARCHITECTURE.md](../SOA_ARCHITECTURE.md).
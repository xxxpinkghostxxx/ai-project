...
def test_critical_imports() -> Tuple[bool, Dict[str, Any]]:
    ...
    critical_modules = [
        ...
        "simulation_manager", "ui_engine", "behavior_engine",
        "node_access_layer", "energy_behavior", "connection_logic",
        "node_id_manager", "config_manager", "performance_monitor",
        "spike_queue_system", "event_driven_system", "live_hebbian_learning",
        "neural_map_persistence", "sensory_workspace_mapper", "visual_energy_bridge",
        "audio_to_neural_bridge", "enhanced_neural_integration", "workspace_engine",
        "learning_engine", "homeostasis_controller", "network_metrics", "memory_system"
    ]
    failed_imports = []
    successful_imports = []
...
def test_simulation_manager_creation() -> Tuple[bool, Dict[str, Any]]:
    ...
    try:
        ...
        from node_id_manager import force_reset_id_manager

...
try:
    ...
    from enhanced_neural_dynamics import create_enhanced_neural_dynamics
    from enhanced_connection_system import create_enhanced_connection_system
...
from config_manager import get_system_constants, get_learning_config
